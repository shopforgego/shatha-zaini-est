...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 text-purple-950 border-b border-purple-100 backdrop-blur-md shadow-lg">
      <div className="bg-gradient-to-r from-purple-900 via-purple-800 to-purple-900 text-amber-200 font-bold text-xs py-1.5 px-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              onClick={onOpenCart}
              className="relative flex items-center gap-2 bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 hover:from-amber-500 hover:to-amber-700 text-purple-950 font-black shadow-lg shadow-amber-500/20 px-4 py-2.5 rounded-xl transition transform active:scale-95"
            >
