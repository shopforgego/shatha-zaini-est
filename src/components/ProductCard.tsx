...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className="group bg-white border border-purple-100 hover:border-purple-400 shadow-sm hover:shadow-xl rounded-2xl overflow-hidden transition-all duration-300 flex flex-col">
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        <div>
          <span className="text-[11px] text-purple-600 font-bold mb-1 block">{product.category}</span>
          <h3
        ...
        <div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 hover:from-amber-500 hover:to-amber-700 text-purple-950 font-black shadow-lg shadow-amber-500/20 py-2.5 px-3 rounded-xl transition text-xs font-bold"
          >
